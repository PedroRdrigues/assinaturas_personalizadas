...
class App(customtkinter.CTk):
    ...
    def widgets(self):
        ...
        self.entry = customtkinter.CTkEntry(self ,placeholder_text="E-mail User")
        self.entry.grid(row=0, column=0, padx=20, pady=(0, 20), sticky="ew", columnspan=2)
        
        # Checkbox para configuração do Outlook.
        self.checkbox_outlook = customtkinter.CTkCheckBox(self, text="Outlook")
        self.checkbox_outlook.grid(row=1, column=0, padx=20, pady=(0, 20), sticky="e")

        # Checkbox para configuração do ThunderBird.
        self.checkbox_thunderbird = customtkinter.CTkCheckBox(self, text="ThunderBird")
        self.checkbox_thunderbird.grid(row=1, column=1, padx=20, pady=(0, 20), sticky="w")
        
        # Botão para gerar o arquivo .xml com o nome do usuário.
        self.button = customtkinter.CTkButton(self, text="Gerar AutoSign", command=self.button_callback)
